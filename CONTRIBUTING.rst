...
padme could always use more documentation, whether as part of the
official padme docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
https://github.com/zyga/padme/issues.
...
3. The pull request should work for Python 2.7, 3.2, 3.3, and 3.4, and for
   PyPy. Check https://travis-ci.org/zyga/padme/pull_requests
